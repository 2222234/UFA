...
public class RandomEvents extends UFACommandToDo {
    private final MapManager mapManager;

    public RandomEvents(UFACommandToDo superCmd, ModeManager modeManager, Message message) {
    ...
    public void toDo(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (args.length == 1) {
            map.getSets().setRandomEvents(Boolean.parseBoolean(args[0]));
