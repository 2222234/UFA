...
public class GameAreaInfo extends UFACommandToDo {
    private final MapManager mapManager;

    public GameAreaInfo(UFACommandToDo superCmd, ModeManager modeManager, Message message) {
    ...
    public void toDo(CommandSender sender, Command command, String label, String[] args) {
        ...
        switch (args.length) {
            case 0:
                sender.sendMessage(message.getGame("info.area_tip", map));
