...
public class BlockTime extends UFACommandToDo {
    private final MapManager mapManager;

    public BlockTime(UFACommandToDo superCmd, ModeManager modeManager, Message message) {
    ...
    public void toDo(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (args.length == 2) {
            try {
                ...
                if (map.getBlocks().setRepTime(num, repTime)) {
